...
- **Responsive**: On mobile viewports (≤768px), the toolbar shifts to a fixed floating bottom bar pinned above browser navigation with safe-area insets and `100dvh` viewport support, while context menus seamlessly morph into slide-up glass bottom sheet drawers with touch-friendly targets.
